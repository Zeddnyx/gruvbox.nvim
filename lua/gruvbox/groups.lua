...
local M = {
  ...
  NvimTreeFolderName = { fg = c.light0 },
  ...
  BufferCurrentIndex = { bg = c.dark0, fg = c.light0 },
  ...
  BufferInactive = { bg = c.dark0, fg = c.light0 },
  BufferInactiveIndex = { bg = c.dark0, fg = c.light0 },
  BufferInactiveMod = { bg = c.dark0, fg = c.red},
